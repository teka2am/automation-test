    ...
    public static WebDriver initDriver() {
        ...
        switch (TestConfigs.getBrowserName()) {
            ...
            case "edge":
                ...
                break;
            default:
                Reporting.warning("Property [" + TestConfigs.TEST_PROPERTIES_BROWSER_NAME + "=" + TestConfigs.getBrowserName() + "] is not defined properly. Default [" + TestConfigs.TEST_PROPERTIES_BROWSER_NAME + "] will be set as [" + TestConfigs.DEFAULT_BROWSER_NAME + "]");
                WebDriverManager.chromedriver().setup();
                driver = new ChromeDriver();
        }
